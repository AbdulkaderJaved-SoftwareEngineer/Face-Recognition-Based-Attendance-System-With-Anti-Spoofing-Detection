...
class AttendanceSystem:
    ...
    def open_camera(self):
        if self.video_running:
            ...
            if ret:
                ...
                img = cv2.cvtColor(img,cv2.COLOR_BGR2RGB)
                ##frame1 = detect(frame, faceCascade, eyesCascade, noseCascade, mouthCascade)
            ...
            # Call this method again after a small delay (e.g., 30ms for ~33fps)
    ...
    def stop_video_stream(self):
        if self.video_running:
            ...
            self.video_label.configure(image='')  # Clear the video display
